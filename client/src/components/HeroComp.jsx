...
const HeroComp = () => {
  return (
    <div className="md:grid md:grid-flow-col md:gap-16 md:mt-10x justify-center">
      ...
      <div className="row-span-3 flex flex-col">
        ...
        <button className=" md:ml-10 font-semibold bg-primaryColor p-4 px-8 text-textColor rounded-lg mt-8" src="https://blog.chain.link/cross-chain-defi/#:~:text=Cross%2Dchain%20lending%20allows%20users,within%20that%20on%2Dchain%20environment.">
          Learn more
        </button>
      </div>
