...
const LiquidateNFT = ({ lendBorrowContract, signer }) => {
  ...
  return (
    <div className="max-w-md mx-auto mt-6 " style={{height: '540px'}}>
      <form className="bg-green-900 shadow-md rounded px-8 pt-6 pb-8 mb-4" style={{backgroundColor: 'white'}}>
        <div className="mb-4">
          <label className="block text-sm font-bold text-green-400 mb-2" style={{color: '#2135e5'}} htmlFor="tokenContractAddress">
